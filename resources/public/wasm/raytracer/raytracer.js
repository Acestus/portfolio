export class Raytracer {
     ...
     */
    constructor(canvas) {
        const ret = wasm.raytracer_new(canvas);
        if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./raytracer_bg.js": import0,
    };
}

const RaytracerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_raytracer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('raytracer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
