...
export class Life {
     ...
     */
    generation() {
        const ret = wasm.life_generation(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    height() {
        const ret = wasm.life_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    constructor(canvas) {
        const ret = wasm.life_new(canvas);
        if (ret[2]) {
     ...
     */
    population() {
        const ret = wasm.life_population(this.__wbg_ptr);
        return ret >>> 0;
    }
    render() {
        wasm.life_render(this.__wbg_ptr);
    }
    tick() {
        wasm.life_tick(this.__wbg_ptr);
    }
    /**
     * @param {number} canvas_x
     * @param {number} canvas_y
     */
    toggle_at(canvas_x, canvas_y) {
        wasm.life_toggle_at(this.__wbg_ptr, canvas_x, canvas_y);
    }
    /**
     * @returns {number}
     */
    width() {
        const ret = wasm.life_width(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('life_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
